...
namespace Unity.VisualScripting
{
    public static class SavedVariables
    {
        ...
        public const string SessionManagerKey = "LudiqSavedVariables";
        ...
        public static void SaveDeclarations(VariableDeclarations declarations)
        {
            ...
            try
            {
                ...
                SessionManager.SetString(SessionManagerKey, data.json);
                SessionManager.Save();
            }
            catch (Exception ex)
            {
        ...
        {
            if (SessionManager.HasKey(SessionManagerKey))
            {
                try
                {
                    saved = (VariableDeclarations)new SerializationData(SessionManager.GetString(SessionManagerKey)).Deserialize();
                }
                catch (Exception ex)
                {
