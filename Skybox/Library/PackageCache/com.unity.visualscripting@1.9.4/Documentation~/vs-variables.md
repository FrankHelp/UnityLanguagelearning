...
<td>Saved variables are like Application variables, but they persist even after your application quits. You can use a Saved variable as a simple but powerful save system. Unity stores Saved variables in its <code>SessionManager</code>, and they don't refer to Unity objects, like GameObjects and components. For more information on <code>SessionManager</code>, see <a href="https://docs.unity3d.com/ScriptReference/SessionManager.html">SessionManager</a> in the Unity User Manual Scripting Reference.</td>
</tr>
</tbody>
</table>
